            ...
            <div class="row flex-nowrap">
                ...
                <div class="bg-dark col-auto col-md-4 col-lg-2 min-vh-100 d-flex flex-column justify-content-between">
                    <div class="bg-dark p-2">
                        ...
                        <div class="d-flex justify-content-center h4 font-family mt-2 admin-name text-white">{{auth()->user()->name}}</div>


                        <ul class="nav nav-pills flex-column mt-4">

                            <div class="nav-item py-2 py-sm-0 nav_hover  @if(request()->routeIs('doctor.appointments')) active mb-1 mt-1 @endif">
                                <a href="{{route('doctor.appointments')}}" class="nav-link d-flex align-items-center">
                                    <svg class="bi me-2" width="24" height="40" fill="#FFFFFF">
                                        <use xlink:href="#home" />
                                    </svg>
                                    <span class="fs-5 d-none d-sm-inline ms-2">Appointments</span>
                                </a>
                            </div>
                            ...
                            <div class="col-12 nav-item py-2 py-sm-0 nav_hover">
                                ...
                                <a class="nav-link d-flex align-items-center" href="{{ route('doctor.logout') }}" onclick="event.preventDefault();
document.getElementById('logout-form').submit();">
                                    <svg class="bi me-2" width="20" height="40" fill="#FFFFFF">
                                        <use xlink:href="#logout" />
                                    </svg>
                                    <span class="fs-5 d-none d-sm-inline ms-2 text-white ">Logout</span>
                                </a>
